...
## Novo Slide {data-background=#00B9E3}

- O texto em cada slide é incluído assim como um arquivo `rmarkdown` usual.

- VocÃª pode usar *texto em itálico* ou **em negrito**.
...
- VocÃªs irÃ£o entregar apenas <span class="red3">**1 (um) arquivo .Rmd**</span>, que deverá incluir tanto o conteúdo da apresentação, como todo o código para executar as análises.

- O código deve ser incluído usando os *chunks* como vocÃªs já estão acostumados. 

- Lembre-se de usar as opções como `echo=FALSE`, `message=FALSE`, `warning=FALSE` quando vocÃªs nÃ£o quiserem mostrar o código e as mensagens de erro nos slides. 
